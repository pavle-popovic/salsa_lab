        ...
        <section id="about" className="py-32 px-6 max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div data-aos="fade-right" className="relative">
                    ...
                    <img src="https://images.unsplash.com/photo-1545959798-ac97e937d99f?auto=format&fit=crop&w=800&q=80" className="relative rounded-2xl shadow-2xl border border-gray-800" alt="Person dancing salsa" />
                    <div data-aos="zoom-in" data-aos-delay="300" className="absolute -bottom-6 -right-6 bg-gray-900 p-4 rounded-xl border border-gray-700 shadow-xl flex items-center gap-3">
